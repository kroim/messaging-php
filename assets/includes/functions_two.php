...
function Wo_CountAllData($type) {
    ...
    if ($type == 'user') {
        ...
        $type_table = T_PRODUCTS;
        $type_id    = 'id';
    } else if ($type == 'langs') {
        $type_table = T_LANGS;
        $type_id    = 'id';
    }else if ($type == 'usersads') {
        $type_table = T_USERADS;
        $type_id    = 'id';
    }else if ($type == 'VideoCalles') {
        $type_table = T_VIDEOSCALLES;
        $type_id    = 'id';
    }else if ($type == 'blog') {
        $type_table = T_BLOG;
        $type_id    = 'id';
    }else if ($type == 'Announcement') {
        $type_table = T_Announcement;
        $type_id    = 'id';
    }else if ($type == 'Announcement_Views') {
        $type_table = T_Announcement_Views;
        $type_id    = 'id';
    }else if ($type == 'AudioCalls') {
        $type_table = T_AudioCalls;
        $type_id    = 'id';
    }else if ($type == 'BlogCommentReplies') {
        $type_table = T_BlogCommentReplies;
        $type_id    = 'id';
    }else if ($type == 'BlogComments') {
        $type_table = T_BlogComments;
        $type_id    = 'id';
    }else if ($type == 'Events') {
        $type_table = T_Events;
        $type_id    = 'id';
